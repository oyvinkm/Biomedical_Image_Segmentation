...
class CNN(nn.Module):
    def __init__(self, in_channels, parameters = None, base_features = 16):
        ...
        self.aske2_layer2 = self._conv_layer_set(self.base_features, self.base_features)
        self.aske_upconv1 = self.upconv(self.base_features, self.base_features, 2, 2)

        #decode layer
        self.aske3_layer1 = self._conv_layer_set(self.base_features + self.base_features, 8)
        self.aske3_layer2 = self._conv_layer_set(8, 8)
        self.aske3_layer3 = self._conv_layer_set(8, 1)

        


    """         #Layer Encode 1
        self.conv1_layer1 = self._conv_layer_set(self.in_channels, 16)
        self.conv1_layer2 = self._conv_layer_set(16, self.base_features)
        ...
        self.conv7_layer2 = self._conv_layer_set(self.base_features, 16)

        #Output
        self.final_conv = self._conv_layer_set(16, 1) """
