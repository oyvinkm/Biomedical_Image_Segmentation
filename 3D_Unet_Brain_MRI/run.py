...
cluster_path = os.path.join(os.getcwd(), 'Cropped_Task3/crop_sub-233/crop_sub-233_space-T1_desc-masked_T1.nii.gz')
...
net_trainer = NetworkTrainer(device = device, network=network, epochs = epochs, loss_func=loss_func, batch_size=batch_size,
                            ...
                            output_folder=out_folder, affine=test_imgur_affine, model_kwargs=model_kwargs, dialate_p=dialation_prob, dialate_epochs=dialation_epochs, dialate=dialation)
